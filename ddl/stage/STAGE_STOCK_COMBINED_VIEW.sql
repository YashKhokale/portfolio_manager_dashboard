CREATE OR REPLACE VIEW STAGE.STAGE_STOCK_COMBINED_VIEW AS
...
WHERE latest_rec=1
AND (STOCK_SYMBOL_KEY <> '00000000000000000000000000000000' AND DATE_KEY <> '00000000000000000000000000000000')
;